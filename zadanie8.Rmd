...
Uvedomil som si, že teraz môžem aplikovať "lifehack" a jednoducho zosumovať stĺpce :-)
```{r}
...
A môžeme ísť na graf:
```{r}
ggplot (data = Q_p, aes(x = p1, y = Q)) + geom_line() + geom_point()
```

Ešte skúsim spraviť druhú úlohu so vzorcom, kde pridám od oboch integrálov y.
```{r}
Data_mix_y <- Data_mix
```

```{r}
Data_mix_y <- mutate(Data_mix_y, x_y_0.00 = (Q * y * ((0.00 * f_214) + ((1-0.00)*f_218)) * 3.624374), norma_y_0.00 = (((0.00 * f_214) + ((1-0.00)*f_218)) * 3.624374 * y), x_y_0.05 = (Q * y * ((0.05 * f_214) + ((1-0.05)*f_218)) * 3.624374), norma_y_0.05 = (((0.05 * f_214) + ((1-0.05)*f_218)) * 3.624374 * y), x_y_0.10 = (Q * y * ((0.10 * f_214) + ((1-0.10)*f_218)) * 3.624374), norma_y_0.10 = (((0.10 * f_214) + ((1-0.10)*f_218)) * 3.624374 * y), x_y_0.15 = (Q * y * ((0.15 * f_214) + ((1-0.15)*f_218)) * 3.624374), norma_y_0.15 = (((0.15 * f_214) + ((1-0.15)*f_218)) * 3.624374 * y), x_y_0.20 = (Q * y * ((0.20 * f_214) + ((1-0.20)*f_218)) * 3.624374), norma_y_0.20 = (((0.20 * f_214) + ((1-0.20)*f_218)) * 3.624374 * y), x_y_0.25 = (Q * y * ((0.25 * f_214) + ((1-0.25)*f_218)) * 3.624374), norma_y_0.25 = (((0.25 * f_214) + ((1-0.25)*f_218)) * 3.624374 * y), x_y_0.30 = (Q * y * ((0.30 * f_214) + ((1-0.30)*f_218)) * 3.624374), norma_y_0.30 = (((0.30 * f_214) + ((1-0.30)*f_218)) * 3.624374 * y), x_y_0.35 = (Q * y * ((0.35 * f_214) + ((1-0.35)*f_218)) * 3.624374), norma_y_0.35 = (((0.35 * f_214) + ((1-0.35)*f_218)) * 3.624374 * y), x_y_0.40 = (Q * y * ((0.40 * f_214) + ((1-0.40)*f_218)) * 3.624374), norma_y_0.40 = (((0.40 * f_214) + ((1-0.40)*f_218)) * 3.624374 * y), x_y_0.45 = (Q * y * ((0.45 * f_214) + ((1-0.45)*f_218)) * 3.624374), norma_y_0.45 = (((0.45 * f_214) + ((1-0.45)*f_218)) * 3.624374 * y), x_y_0.50 = (Q * y * ((0.50 * f_214) + ((1-0.50)*f_218)) * 3.624374), norma_y_0.50 = (((0.50 * f_214) + ((1-0.50)*f_218)) * 3.624374 * y), x_y_0.55 = (Q * y * ((0.55 * f_214) + ((1-0.55)*f_218)) * 3.624374), norma_y_0.55 = (((0.55 * f_214) + ((1-0.55)*f_218)) * 3.624374 * y), x_y_0.60 = (Q * y * ((0.60 * f_214) + ((1-0.60)*f_218)) * 3.624374), norma_y_0.60 = (((0.60 * f_214) + ((1-0.60)*f_218)) * 3.624374 * y), x_y_0.65 = (Q * y * ((0.65 * f_214) + ((1-0.65)*f_218)) * 3.624374), norma_y_0.65 = (((0.65 * f_214) + ((1-0.65)*f_218)) * 3.624374 * y), x_y_0.70 = (Q * y * ((0.70 * f_214) + ((1-0.70)*f_218)) * 3.624374), norma_y_0.70 = (((0.70 * f_214) + ((1-0.70)*f_218)) * 3.624374 * y), x_y_0.75 = (Q * y * ((0.75 * f_214) + ((1-0.75)*f_218)) * 3.624374), norma_y_0.75 = (((0.75 * f_214) + ((1-0.75)*f_218)) * 3.624374 * y), x_y_0.80 = (Q * y * ((0.80 * f_214) + ((1-0.80)*f_218)) * 3.624374), norma_y_0.80 = (((0.80 * f_214) + ((1-0.80)*f_218)) * 3.624374 * y), x_y_0.85 = (Q * y * ((0.85 * f_214) + ((1-0.85)*f_218)) * 3.624374), norma_y_0.85 = (((0.85 * f_214) + ((1-0.85)*f_218)) * 3.624374 * y), x_y_0.90 = (Q * y * ((0.90 * f_214) + ((1-0.90)*f_218)) * 3.624374), norma_y_0.90 = (((0.90 * f_214) + ((1-0.90)*f_218)) * 3.624374 * y), x_y_0.95 = (Q * y * ((0.95 * f_214) + ((1-0.95)*f_218)) * 3.624374), norma_y_0.95 = (((0.95 * f_214) + ((1-0.95)*f_218)) * 3.624374 * y), x_y_1.00 = (Q * y * ((1.00 * f_214) + ((1-1.00)*f_218)) * 3.624374), norma_y_1.00 = (((1.00 * f_214) + ((1-1.00)*f_218)) * 3.624374 * y))
```

```{r}
Q_p_y <- tibble(p1 = c(0.00, 0.05, 0.10, 0.15, 0.20, 0.25, 0.30, 0.35, 0.40, 0.45, 0.50, 0.55, 0.60, 0.65, 0.70, 0.75, 0.80, 0.85, 0.90, 0.95, 1.00), Q = c(sum(Data_mix_y$x_y_0.00)/sum(Data_mix_y$norma_y_0.00), sum(Data_mix_y$x_y_0.05)/sum(Data_mix_y$norma_y_0.05), sum(Data_mix_y$x_y_0.10)/sum(Data_mix_y$norma_y_0.10), sum(Data_mix_y$x_y_0.15)/sum(Data_mix_y$norma_y_0.15), sum(Data_mix_y$x_y_0.20)/sum(Data_mix_y$norma_y_0.20), sum(Data_mix_y$x_y_0.25)/sum(Data_mix_y$norma_y_0.25), sum(Data_mix_y$x_y_0.30)/sum(Data_mix_y$norma_y_0.30), sum(Data_mix_y$x_y_0.35)/sum(Data_mix_y$norma_y_0.35), sum(Data_mix_y$x_y_0.40)/sum(Data_mix_y$norma_y_0.40), sum(Data_mix_y$x_y_0.45)/sum(Data_mix_y$norma_y_0.45), sum(Data_mix_y$x_y_0.50)/sum(Data_mix_y$norma_y_0.50), sum(Data_mix_y$x_y_0.55)/sum(Data_mix_y$norma_y_0.55), sum(Data_mix_y$x_y_0.60)/sum(Data_mix_y$norma_y_0.60), sum(Data_mix_y$x_y_0.65)/sum(Data_mix_y$norma_y_0.65), sum(Data_mix_y$x_y_0.70)/sum(Data_mix_y$norma_y_0.70), sum(Data_mix_y$x_y_0.75)/sum(Data_mix_y$norma_y_0.75), sum(Data_mix_y$x_y_0.80)/sum(Data_mix_y$norma_y_0.80), sum(Data_mix_y$x_y_0.85)/sum(Data_mix_y$norma_y_0.85), sum(Data_mix_y$x_y_0.90)/sum(Data_mix_y$norma_y_0.90), sum(Data_mix_y$x_y_0.95)/sum(Data_mix_y$norma_y_0.95), sum(Data_mix_y$x_y_1.00)/sum(Data_mix_y$norma_y_1.00)))
```

```{r}
ggplot (data = Q_p_y, aes(x = p1, y = Q)) + geom_line() + geom_point()
```
